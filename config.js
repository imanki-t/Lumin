...
- send_server_message: Send a message to a server channel. ONLY callable from a DM conversation — never in a server (just reply normally there). Use when a DM user asks you to relay a message to a server channel. Can only reach servers where the bot is active and the user is also a member.
